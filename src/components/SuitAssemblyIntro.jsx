...
const STORY_STEPS = [
  {
    ...
    threshold: 0,
    label: 'Panel 01',
    title: 'Walk to Platform',
    caption: 'Tablet signals readiness. Step onto the evolution disc.',
    sfx: 'SFX: AMBIENT HUM · FIELD ONLINE',
  },
  {
    id: 2,
    threshold: 18,
    label: 'Panel 02',
    title: 'Armor Plates',
    caption: 'CAD segments lock over your frame before the transfer begins.',
  ...
  },
  {
    ...
    label: 'Panel 03',
    title: 'Evolution',
    caption: 'Energy cocoon forms. Your suit materializes inside the light.',
    sfx: 'SFX: WHITE NOISE · CORE CHARGE',
  },
  {
    id: 4,
    threshold: 72,
    ...
    caption: 'The field bursts. Arc reactor online. Bust locked.',
    sfx: 'SFX: FLARE · DEPLOYMENT TONE',
  },
];
    ...
    >
      ...
      <div className="suit-intro__hud">
        <div className="suit-intro__top">
          ...
          >
            {isLite3DDevice() ? 'Tap to skip' : 'Scroll to skip'}
          </button>
        </div>
